 ...
 * @subpackage Geocoder_Map/models/admin
 *
 */
namespace Models\Administer;
use Includes\Geocoder_Map;
use Includes\Geocoder_Map_Actions_Filters;

if ( ! class_exists( 'Geocoder_Map_Model_Admin_Settings' ) ) {

	class Geocoder_Map_Model_Admin_Settings extends Geocoder_Map_Model_Admin {

		protected static $settings;

		const SETTINGS_NAME = Geocoder_Map::PLUGIN_ID;
		...
		protected function register_hook_callbacks() {
			...
			Geocoder_Map_Actions_Filters::add_action( 'admin_init', $this, 'register_settings' );
